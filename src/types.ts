...
export const DEFAULT_TEMAS: TemaConfig[] = [
  ...
  },
  {
    ...
    perguntas: [
      ...
      { id: 'p5', label: 'Qual e o nome do bebe caso seja menino e qual o nome caso seja menina?', p_placeholder: 'Ex: Se for menino se chamara Teo, se for menina se chamara Livia.' },
    ],
  },
];
